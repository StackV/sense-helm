...
| Name                               | Description                                                                                                                              | Value                                            |
| ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ |
| `image.repo`                       | Orchestrator image.                                                                                                                      | `virnao/sense-orchestrator`                      |
...
| `init.migration.enabled`           | Whether to enable the automatic DB migration containers.                                                                                 | `false`                                          |
| `init.migration.image`             | DB migration tooling image.                                                                                                              | `virnao/stackv-db-migration`                     |
| `init.migration.tag`               | DB migration tooling tag.                                                                                                                | `1392-db-migration-tooling`                      |
